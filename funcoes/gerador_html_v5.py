blocos_atrs = ('bloco_acesskey', 'bloco_id')
...
def tag_bloco(conteudo, *args, classe='success', inline=False, **novos_atrs):
    ...
    atributos = filtrar_atrs(novos_atrs, blocos_atrs)
...
if __name__ == '__main__':
    ...
    print(tag_bloco(tag_lista, 'Item 1', 'Item 2', classe='info', bloco_acesskey='m', bloco_id='conteudo', ul_id='lista', ul_style='color:red'))